...
OP( OP_CONCAT,          2, 2, eval_concat, NULL, "CONCAT(value1, value2)", "Returns the concatenation of two values. Equivalent to the `&` operator")
OP( OP_DIVIDE,          2, 2, eval_div, NULL, "DIVIDE(dividend, divisor)", "Returns one number divided by another. Equivalent to the `/` operator")
OP( OP_EQ,              2, 2, eval_cmp, NULL, "EQ(value1, value2)", "Returns `TRUE` if two specified values are equal and `FALSE` otherwise. Equivalent to the `=` operator")
OP( OP_GT,              2, 2, eval_cmp, NULL, "GT(value1, value2)", "Returns `TRUE` if the first argument is strictly greater than the second, and `FALSE` otherwise. Equivalent to the `>` operator")
OP( OP_GTE,             2, 2, eval_cmp, NULL, "GTE(value1, value2)", "Returns `TRUE` if the first argument is greater than or equal to the second, and `FALSE` otherwise. Equivalent to the `>=` operator")
OP( OP_ISBETWEEN,       3, 5, eval_isbetween, NULL, "ISBETWEEN(value_to_compare, lower_value, upper_value, [lower_value_is_inclusive], [upper_value_is_inclusive])", "Checks whether a provided number is between two other numbers either inclusively or exclusively")
OP( OP_LT,              2, 2, eval_cmp, NULL, "LT(value1, value2)", "Returns `TRUE` if the first argument is strictly less than the second, and `FALSE` otherwise. Equivalent to the `<` operator")
OP( OP_LTE,             2, 2, eval_cmp, NULL, "LTE(value1, value2)", "Returns `TRUE` if the first argument is less than or equal to the second, and `FALSE` otherwise. Equivalent to the `<=` operator")
OP( OP_MINUS,           2, 2, eval_sub, NULL, "MINUS(value1, value2)", "Returns the difference of two numbers. Equivalent to the `-` operator")
OP( OP_MULTIPLY,        2, 2, eval_mul, NULL, "MULTIPLY(factor1, factor2)", "Returns the product of two numbers. Equivalent to the `*` operator")
OP( OP_NE,              2, 2, eval_cmp, NULL, "NE(value1, value2)", "Returns `TRUE` if two specified values are not equal and `FALSE` otherwise. Equivalent to the `<>` operator")
OP( OP_POW,             2, 2, eval_fn2, pow, "POW(base, exponent)", "Returns a number raised to a power")
OP( OP_UMINUS,          1, 1, eval_neg, NULL, "UMINUS(value)", "Returns a number with the sign reversed")
OP( OP_UNARY_PERCENT,   1, 1, eval_fn1, math_percent, "UNARY_PERCENT(percentage)", "Returns a value interpreted as a percentage; that is, `UNARY_PERCENT(100)` equals `1`")
...
OP( OP_UPLUS,           1, 1, eval_uplus, NULL, "UPLUS(value)", "Returns a specified number, unchanged")

OP( OP_ADD_,            -3, 2, eval_add, NULL, "+", NULL)
OP( OP_MINUS_,          -3, 2, eval_sub, NULL, "-", NULL)
OP( OP_MULTIPLY_,       -3, 2, eval_mul, NULL, "*", NULL)
OP( OP_DIVIDE_,         -3, 2, eval_div, NULL, "/", NULL)
OP( OP_POW_,            -3, 2, eval_fn2, pow, "^", NULL)
OP( OP_BANG_,           -3, 2, eval_bang, NULL, "!", NULL)
__( OP_TILDE_,          -3, 2, eval_bang, NULL, "~", NULL)
OP( OP_COLON_,          -3, 2, eval_colon, NULL, ":", NULL)
XX( OP_SEMI_,           -3, 2, eval_fl2, makecolor, ";", NULL)
OP( OP_EQ_,             -3, 2, eval_cmp, NULL, "=", NULL)
OP( OP_NE_,             -3, 2, eval_cmp, NULL, "<>", NULL)
XX( OP_NE2_,            -3, 2, eval_cmp, NULL, "!=", NULL)
OP( OP_LT_,             -3, 2, eval_cmp, NULL, "<", NULL)
OP( OP_LTE_,            -3, 2, eval_cmp, NULL, "<=", NULL)
OP( OP_GTE_,            -3, 2, eval_cmp, NULL, ">=", NULL)
OP( OP_GT_,             -3, 2, eval_cmp, NULL, ">", NULL)
OP( OP_CONCAT_,         -3, 2, eval_concat, NULL, "&", NULL)
OP( OP_UMINUS_,         -3, 0, eval_neg, NULL, "-", NULL)
OP( OP_UPLUS_,          -3, 0, eval_uplus, NULL, "+", NULL)
OP( OP_PERCENT_,        -4, 1, eval_fn1, math_percent, "%", NULL)
XX( OP_COMMA_,          -3, 2, NULL, NULL, ",", NULL)
...
OP( OP_DAVERAGE,        3, 3, eval_daverage, NULL, "DAVERAGE(database, field, criteria)", "Returns the average of a set of values selected from a database table-like array or range using a SQL-like query")
OP( OP_DCOUNT,          3, 3, eval_dcount, NULL, "DCOUNT(database, field, criteria)", "Counts numeric values selected from a database table-like array or range using a SQL-like query")
OP( OP_DCOUNTA,         3, 3, eval_dcount, NULL, "DCOUNTA(database, field, criteria)", "Counts values, including text, selected from a database table-like array or range using a SQL-like query")
OP( OP_DGET,            3, 3, eval_dget, NULL, "DGET(database, field, criteria)", "Returns a single value from a database table-like array or range using a SQL-like query")
OP( OP_DMAX,            3, 3, eval_dmax, NULL, "DMAX(database, field, criteria)", "Returns the maximum value selected from a database table-like array or range using a SQL-like query")
OP( OP_DMIN,            3, 3, eval_dmin, NULL, "DMIN(database, field, criteria)", "Returns the minimum value selected from a database table-like array or range using a SQL-like query")
OP( OP_DPRODUCT,        3, 3, eval_dproduct, NULL, "DPRODUCT(database, field, criteria)", "Returns the product of values selected from a database table-like array or range using a SQL-like query")
OP( OP_DSTDEV,          3, 3, eval_dstdev, NULL, "DSTDEV(database, field, criteria)", "Returns the standard deviation of a population sample selected from a database table-like array or range using a SQL-like query")
OP( OP_DSTDEVP,         3, 3, eval_dstdevp, NULL, "DSTDEVP(database, field, criteria)", "Returns the standard deviation of an entire population selected from a database table-like array or range using a SQL-like query")
OP( OP_DSUM,            3, 3, eval_dsum, NULL, "DSUM(database, field, criteria)", "Returns the sum of values selected from a database table-like array or range using a SQL-like query")
OP( OP_DVAR,            3, 3, eval_dvar, NULL, "DVAR(database, field, criteria)", "Returns the variance of a population sample selected from a database table-like array or range using a SQL-like query")
OP( OP_DVARP,           3, 3, eval_dvarp, NULL, "DVARP(database, field, criteria)", "Returns the variance of an entire population selected from a database table-like array or range using a SQL-like query")
